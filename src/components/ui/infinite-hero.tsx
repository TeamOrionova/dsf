...
// Note: Removed SplitText import/plugin registration to ensure compatibility without a GSAP paid license.
// We handle the text animation using a custom reveal logic.
...
export default function InfiniteHero({
    ...
    return (
        <div
            ref={rootRef}
            className={cn("relative w-full overflow-hidden bg-black text-white", height)}
        >
