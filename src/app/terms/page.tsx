        ...
        <main className="max-w-4xl mx-auto py-32 px-6">
            ...
            <div className="prose prose-invert max-w-none text-neutral-400 space-y-6">
                ...
                <section>
                    ...
                    <p>All content and materials on this website are the intellectual property of Ninthcloud Media unless otherwise noted. Unauthorized use is prohibited.</p>
                </section>

                <section>
                    <h2 className="text-2xl font-bold text-white mb-4">4. Limitation of Liability</h2>
                    <p>Ninthcloud Media shall not be liable for any indirect, incidental, or consequential damages resulting from the use of our services or website.</p>
                </section>

                <section>
                    <h2 className="text-2xl font-bold text-white mb-4">5. Governing Law</h2>
                    <p>These terms are governed by the laws of the jurisdiction in which Ninthcloud Media operates.</p>
                </section>
            </div>
        </main>
    );
