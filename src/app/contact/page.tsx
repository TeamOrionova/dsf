    ...
    return (
        <main className="flex min-h-screen flex-col items-center">
            <section className="w-full relative overflow-hidden">
                <BackgroundPaths title="Let’s Scale Together" />
            </section>

            <section className="max-w-7xl mx-auto py-24 px-6 w-full grid grid-cols-1 lg:grid-cols-2 gap-24">
                {/* Contact Info */}
                <div className="flex flex-col justify-center">
                    <h2 className="text-5xl md:text-6xl font-bold mb-8 tracking-tighter">Get in Touch</h2>
                    ...
                    <div className="space-y-8">
                        {/* WhatsApp/Instagram Links remain the same */}
                        <a href="https://wa.me/918269364803" className="flex items-center gap-6 group hover:translate-x-2 transition-transform">
                            ...
                            <span className="text-2xl font-bold text-white uppercase tracking-tighter">Chat on WhatsApp</span>
                        </a>

                        <a href="https://instagram.com/ninthcloudstudio" className="flex items-center gap-6 group hover:translate-x-2 transition-transform">
                            ...
                            <span className="text-2xl font-bold text-white uppercase tracking-tighter">Follow on Instagram</span>
                        </a>
                    </div>
                </div>
                ...
                <div className="p-10 rounded-[2.5rem] bg-neutral-900 border border-neutral-800 shadow-2xl">
                    {!isSubmitted ? (
                        <form onSubmit={handleSubmit} className="space-y-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <div className="space-y-2">
                                    ...
                                    <input required name="name" type="text" className="w-full bg-neutral-950 border border-neutral-800 p-4 rounded-xl focus:outline-none focus:border-white transition-colors" placeholder="John Doe" />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-xs uppercase tracking-widest text-neutral-500 font-bold">Email</label>
                                    <input required name="email" type="email" className="w-full bg-neutral-950 border border-neutral-800 p-4 rounded-xl focus:outline-none focus:border-white transition-colors" placeholder="john@example.com" />
                                </div>
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs uppercase tracking-widest text-neutral-500 font-bold">Phone</label>
                                <input required name="phone" type="text" className="w-full bg-neutral-950 border border-neutral-800 p-4 rounded-xl focus:outline-none focus:border-white transition-colors" placeholder="+91 8269364803" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs uppercase tracking-widest text-neutral-500 font-bold">How can we help?</label>
                                <textarea required name="message" rows={4} className="w-full bg-neutral-950 border border-neutral-800 p-4 rounded-xl focus:outline-none focus:border-white transition-colors resize-none" placeholder="Tell us about your project..."></textarea>
                            </div>
                            <Button
                                disabled={isSubmitting}
                                className="w-full py-8 rounded-2xl text-lg font-bold uppercase tracking-widest italic transition-all hover:scale-[1.02]"
                            >
                        ...
                        <div className="py-20 text-center">
                            <h2 className="text-4xl font-bold mb-4 uppercase tracking-tighter">Message Sent!</h2>
                            <p className="text-neutral-400 text-lg">We've received your request and will get back to you within 24 hours.</p>
                        </div>
                    )}
                </div>
            </section>
